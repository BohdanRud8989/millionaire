...
const Hexagon = ({ variant = 'inactive', type = 'stretched', text, prefix, centered, ...props }: HexagonProps) => {
    const { isLg } = useBreakpoints()
    const { width, height, viewBox, containerPath, leftArrowPath, rightArrowPath, y } = SVGConfig[type][isLg ? 'desktop': 'mobile']
